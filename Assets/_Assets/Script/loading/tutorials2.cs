            ...
            if (Input.touches.Length > 0)
            {
              lineRend.enabled = true;
                ...
                // if (blocks.Count > 0)
                {
                    ...
                    if (blockfinal.idColor % 20 == 3 || blockfinal.idColor % 20 == 4 || blockfinal.idColor % 20 == 11 || blockfinal.idColor % 20 == 15)
                    {
                        blockfinal.text.color = Color.black;
                    }
                    else
                    {

                        blockfinal.text.color = Color.white;
